...
<p align="center">
  <a href="https://github.com/provii/provii-mobile/actions/workflows/ci.yml"><img src="https://github.com/provii/provii-mobile/actions/workflows/ci.yml/badge.svg?branch=main" alt="CI"></a>
  <img src="https://img.shields.io/badge/licence-BUSL--1.1-blue" alt="Licence: BUSL-1.1">
...
[Business Source License 1.1](./LICENSE). Copyright 2024-2026 Maelstrom AI Pty Ltd ATF Maelstrom AI Holding Trust. The licence converts to Apache 2.0 on the change date specified in the licence file.
